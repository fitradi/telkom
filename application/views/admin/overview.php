	...
	<div id="content-wrapper">
		...
		<div class="row">
			...
			<div class="card text-white bg-primary o-hidden h-100">
				...
				<div class="mr-5"  > <?php echo $glv; ?> GOLIVE </div>
				</div>
			...
			<div class="card text-white bg-warning o-hidden h-100">
				...
				<a class="card-footer text-white clearfix small z-1" href="admin/sales">
				<span class="float-left">View Details</span>
				<span class="float-right">
					<i class="fas fa-angle-right"></i>
				</span>
			...
			<div class="card text-white bg-success o-hidden h-100">
				...
				<div class="mr-5"><?php echo $submit; ?> Submitted</div>
				</div>
				<a class="card-footer text-white clearfix small z-1" href="admin/sales">
				<span class="float-left">View Details</span>
				<span class="float-right">
			...
			<div class="card text-white bg-primary o-hidden h-100">
				...
				<div class="mr-5"  > <?php echo $fisik; ?> Fisik DONE </div>
				</div>
				<a class="card-footer text-white clearfix small z-1" href=admin/products>
				<span class="float-left">View Details</span>
				<span class="float-right">
		...
		<div class="col-xl-3 col-sm-6 mb-3">
			<div class="card text-white bg-success o-hidden h-100">
				...
				<div class="mr-5"><?php echo $progress; ?> On Progress</div>
				</div>
				<a class="card-footer text-white clearfix small z-1" href="admin/sales">
				<span class="float-left">View Details</span>
				<span class="float-right">
			...
			<div class="card text-white bg-primary o-hidden h-100">
				...
				<div class="mr-5"  > <?php echo $cek; ?> Checking </div>
				</div>
				<a class="card-footer text-white clearfix small z-1" href=admin/products>
				<span class="float-left">View Details</span>
				<span class="float-right">
		...
		<div class="col-xl-3 col-sm-6 mb-3">
			<div class="card text-white bg-warning o-hidden h-100">
				...
				<div class="mr-5"> <?php echo $drawing; ?> Drawing</div>
				</div>
				<a class="card-footer text-white clearfix small z-1" href="admin/sales">
				<span class="float-left">View Details</span>
				<span class="float-right">
			...
			<div class="card text-white bg-success o-hidden h-100">
				...
				<div class="mr-5"><?php echo $push; ?> Push UIM</div>
				</div>
				<a class="card-footer text-white clearfix small z-1" href="admin/sales">
				<span class="float-left">View Details</span>
				<span class="float-right">
...
<form action="<?php echo site_url('admin/overview/create');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
				...
				<div class="form-group">
							<label for="image">Upload desain & RAB</label>
